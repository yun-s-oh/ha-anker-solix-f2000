---
name: openspec-update-docs
description: Update, review, and validate project and API documentation following OpenSpec standards. Use when you need to align setup guides, BLE protocol specifications, or developer/agent guidelines with the current codebase.
license: MIT
compatibility: Requires standard git workspace and markdown capabilities.
metadata:
  author: openspec
  version: "1.0"
  generatedBy: "1.3.1"
