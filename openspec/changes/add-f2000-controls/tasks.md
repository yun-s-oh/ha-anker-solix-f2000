...
- [x] 1.4.3 Verify unencrypted Power Saving Mode toggle commands and validate State ACK updates
- [x] 1.4.4 Test LED Brightness level commands (Off, Low, Mid, High, SOS) and validate State ACK updates
